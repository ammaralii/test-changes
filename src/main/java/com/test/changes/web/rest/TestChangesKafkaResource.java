...
@RestController
@RequestMapping("/api/test-changes-kafka")
public class TestChangesKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TestChangesKafkaResource.class);
    ...
    public TestChangesKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
