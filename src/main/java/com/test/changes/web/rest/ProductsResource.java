...
import com.test.changes.service.ProductsQueryService;
import com.test.changes.service.ProductsService;
...
/**
 * REST controller for managing {@link com.test.changes.domain.Products}.
 */
@RestController
@RequestMapping("/api")
public class ProductsResource {
    ...
    private static final String ENTITY_NAME = "testChangesProducts";
