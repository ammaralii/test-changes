...
describe('PaymentMethods Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'testchanges/payment-methods', component: PaymentMethodsComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to paymentMethodsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPaymentMethodsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPaymentMethodsIdentifier).toHaveBeenCalledWith(entity);
