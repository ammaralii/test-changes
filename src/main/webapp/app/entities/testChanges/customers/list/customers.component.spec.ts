...
describe('Customers Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'testchanges/customers', component: CustomersComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to customersService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCustomersIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCustomersIdentifier).toHaveBeenCalledWith(entity);
