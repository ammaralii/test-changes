...
describe('OrderDetails routing resolve service', () => {
  ...
  let resultOrderDetails: IOrderDetails | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultOrderDetails).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IOrderDetails>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
