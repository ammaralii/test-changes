...
describe('OrderDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'testchanges/order-details', component: OrderDetailsComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to orderDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrderDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrderDetailsIdentifier).toHaveBeenCalledWith(entity);
