...
describe('Colors Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'testchanges/colors', component: ColorsComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to colorsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getColorsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getColorsIdentifier).toHaveBeenCalledWith(entity);
