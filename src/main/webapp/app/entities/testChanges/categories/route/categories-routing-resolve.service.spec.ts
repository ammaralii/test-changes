...
describe('Categories routing resolve service', () => {
  ...
  let resultCategories: ICategories | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ICategories returned by find', () => {
      ...
      expect(resultCategories).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCategories).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICategories>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
