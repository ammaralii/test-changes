...
describe('ShippingDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'testchanges/shipping-details', component: ShippingDetailsComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.shippingDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to shippingDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getShippingDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getShippingDetailsIdentifier).toHaveBeenCalledWith(entity);
