...
describe('Addresses Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'testchanges/addresses', component: AddressesComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to addressesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAddressesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAddressesIdentifier).toHaveBeenCalledWith(entity);
