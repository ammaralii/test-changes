...
describe('ProductDetails routing resolve service', () => {
  ...
  let resultProductDetails: IProductDetails | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultProductDetails).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IProductDetails>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
